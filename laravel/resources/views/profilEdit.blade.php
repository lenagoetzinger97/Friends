                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row interests">
                                ...
                                ?>
                                    <div class="col-md-3">
                                        <input type="checkbox" name="interest{{ $interest->id }}" id="interest{{ $interest->id }}">
                                        <label for="interest{{ $interest->id }}">
                                            {{ $interest->bezeichnung }}
                                        </label>
                                    </div>
                                <?php
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row ceigenschaften">

                                <?php

                                    foreach ($ceigenschaften as $ceigenschaft) {

                                ?>
                                    <div class="col-md-3">
                                        <input type="checkbox" name="ceigenschaft{{ $ceigenschaft->id }}" id="ceigenschaft{{ $ceigenschaft->id }}">
                                        <label for="ceigenschaft{{ $ceigenschaft->id }}">
                                            {{ $ceigenschaft->bezeichnung }}
                                        </label>
                                    </div>
                                <?php
                        ...
                        <div class="col">
                            ...
                            <div class="row music">
                                ...
                                <?php
                                    ...
                                    foreach ($musikgeschmaecker as $musikgeschmack) {

                                ?>
                                    <div class="col-md-3">
                                        <input type="checkbox" name="musikgeschmack{{ $musikgeschmack->id }}" id="musikgeschmack{{ $musikgeschmack->id }}">
                                        <label for="musikgeschmack{{ $musikgeschmack->id }}">
                                            {{ $musikgeschmack->bezeichnung }}
                                        </label>
                                    </div>
                                <?php
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="row urlaub">

                                        <?php

                                            foreach ($urlaubstypen as $urlaubstyp) {

                                        ?>
                                        <div class="col-md-3">
                                            <input type="checkbox" data-id="{{ $urlaubstyp->id }}" name="urlaubstyp{{ $urlaubstyp->id }}" id="urlaubstyp{{ $urlaubstyp->id }}">
                                            <label for="urlaubstyp{{ $urlaubstyp->id }}">
                                                {{ $urlaubstyp->bezeichnung }}
                                            </label>
                                        </div>
                                        <?php
