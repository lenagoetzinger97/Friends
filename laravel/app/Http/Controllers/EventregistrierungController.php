...
class EventregistrierungController extends Controller
{
    ...
    /send_email.php
    $email_from = "lenagoetzinger@hotmail.com";   //Absender falls keiner angegeben wurde
    $sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
    $name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht

    $empfaenger = "lenagoetzinger@hotmail.com"; //Empfänger-Adresse
    $mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
    $betreff = "Neue Kontaktanfrage"; //Betreff der Email

    $url_ok = '/home'; //Zielseite, wenn E-Mail erfolgreich versendet wurde
    $url_fehler = '/home'; //Zielseite, wenn E-Mail nicht gesendet werden konnte
